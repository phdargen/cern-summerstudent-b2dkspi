...
{   
	...
	///Load file
	TFile* file= new TFile("/afs/cern.ch/work/y/yuxiao/public/WeightTreeLL.root");
	...
	RooRealVar nsig1("nsig1","nsig1",5.2085e+02/*,1.2682e+03-1.44e+02,1.2682e+03+1.44e+02*/);
	RooRealVar nsig2("nsig2","nsig2",1.6172e+02/*,1.1019e+03-1.44e+02,1.1019e+03+1.44e+02*/);
	RooFormulaVar f("f","f","nsig1/(nsig1+nsig2)",RooArgList(nsig1,nsig2));
	RooRealVar s1("s1","s1",3.9088e-02/*,3.0273e-02-2.17e-03,3.0273e-02+2.17e-03*/);//e-3ns
	RooRealVar s2("s2","s2",8.4371e-02/*,7.1769e-02-3.74e-03,7.1769e-02+3.74e-03*/);//e-3ns
	...
	//acceptance function
	//--------
	RooRealVar lam("lam","lam",-2.4994e+03/*,-1979.2-339.,-1979.2+339.*/);//ns^-1
	RooRealVar beta("beta","beta",27.059/*,15.052-283.,15.052+283.*/);//ns^-1
	RooRealVar del("del","del",2.0028e-04/*,2.5174e-04-4.81e-05,2.5174e-04+4.81e-05*/);//ns^-1
