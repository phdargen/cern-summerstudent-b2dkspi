...
{   
	...
	RooRealVar sigma1("\\sigma_{1}", "sigma1", 20.,0.,40.);	

	RooGaussian Gauss1("Gauss1", "Gauss1", B_DTF_MM, mean, sigma1);

	RooRealVar mean2("mean2", "mean2", 5080.,4950.,5150.);
	RooRealVar sigma2("sigma2", "sigma2", 70.,40.,80.);
	...
	//pdf list
	RooAbsPdf* bkg = new RooAddPdf("bkg", "bkg", exp, n_bkg);
