...
/*
	Double_t B_DTF_MM1;
	tree->SetBranchAddress("B_DTF_MM",&B_DTF_MM1);
	TH1F *Data = new TH1F("Data","Data",100,5000.,5800.);
...
*/
    ...
    RooChebychev cheby("cheby", "cheby", B_DTF_MM, RooArgList(xa1, xa2, xa3));
	...
	RooAbsPdf* sig2 = new RooAddPdf("sig2", "sig2", Crys2, n_sig2);
