...
void BsDstKsK_DD() {
    ...
    tree->Add("/eos/lhcb/user/p/phdargen/summerStudents21/Stripped/MC_B2DKspi_DD_12_BsDstKsK.root");
	...
	//Create output file
	TFile* output = new TFile("/afs/cern.ch/work/y/yuxiao/public/Dalitz/dalitz_BsDstKsK_DD.root","RECREATE");
	...
	c->SaveAs("Dalitz_BsDstKsK_DD.png");
