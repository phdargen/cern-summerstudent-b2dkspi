...
void sigLL() {
    ...
    tree->Add("/eos/lhcb/user/p/phdargen/summerStudents21/Stripped/MC_B2DKspi_LL_12.root");
	...
	//Create output file
	TFile* output = new TFile("/afs/cern.ch/work/y/yuxiao/public/Dalitz/dalitz_sig_LL.root","RECREATE");
