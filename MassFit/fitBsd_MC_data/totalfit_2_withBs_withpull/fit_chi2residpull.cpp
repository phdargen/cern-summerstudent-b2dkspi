...
{   
	...
	RooChebychev cheby("cheby", "cheby", B_DTF_MM, RooArgList(xa1,xa2));
	...
	pdf.plotOn(frame_m,Components(CBBs),LineColor(7), LineStyle(1), Name("Bsbkg"));
	...
	TCanvas* c = new TCanvas("fit_chi2residpull","fit_chi2residpull",400,600) ;
	c->Divide(1,2) ;
	c->cd(1) ; gPad->SetLeftMargin(0.15) ; frame_m->GetYaxis()->SetTitleOffset(1.6) ; frame_m->Draw() ; leg.DrawClone();
	//c->cd(2) ; gPad->SetLeftMargin(0.15) ; frame2->GetYaxis()->SetTitleOffset(1.6) ; frame2->Draw() ;
	c->cd(2) ; gPad->SetLeftMargin(0.15) ; frame3->GetYaxis()->SetTitleOffset(1.6) ; frame3->Draw() ;
	 
	c->SaveAs("withpull.png");
