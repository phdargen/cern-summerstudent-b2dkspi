...
{   
	...
	///Load file
	TFile* file= new TFile("/eos/lhcb/user/p/phdargen/summerStudents21/Stripped/MC_B2DKspi_LL_12_BdDstKspi.root");
    ...
    //Define branches
	RooRealVar B_DTF_MM("B_DTF_MM", "m(DK_{s}#pi)", 4900., 5800.,"MeV");
    ...
    ///Gaussian
	RooRealVar mean1("mean1", "mean1", 5080.,5085.,5075.); 
	...
	//RooBreitWigner Gauss1("Gauss1", "Gauss1", B_DTF_MM, mean1, sigma1);

	RooRealVar mean2("mean2", "mean2", 5105.,5100.,5115.);
	RooRealVar sigma2("sigma2", "sigma2", 5., 0., 40.);
	RooGaussian Gauss2("Gauss2", "Gauss2", B_DTF_MM, mean2, sigma2);
	//RooBreitWigner Gauss2("Gauss2", "Gauss2", B_DTF_MM, mean2, sigma2);
 
	RooRealVar mean3("mean3", "mean3", 5220.,5100.,5260.);
	RooRealVar sigma3("sigma3", "sigma3", 20. ,0.,70.);
	...
	RooRealVar n_sig3("n_sig3", "n_sig3", data->numEntries()/10.,0.,data->numEntries()/2);
