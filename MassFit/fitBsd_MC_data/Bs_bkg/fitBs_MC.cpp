...
{   
    ...
    ///Gaussian
	RooRealVar mean1("mean1", "mean1", 5120.,5100.,5180.); 
	RooRealVar sigma1("\\sigma_{1}", "sigma1", 50.,0.,120.);	
	...
	RooRealVar mean2("mean2", "mean2", 5180.,5160.,5200.);
	...
	RooRealVar mean3("mean3", "mean3", 5280.,5240.,5400.);
	RooRealVar sigma3("sigma3", "sigma3", 20. ,0.,100.);
	...
	RooRealVar n_sig3("n_sig3", "n_sig3", data->numEntries()/2.,0.,data->numEntries());
