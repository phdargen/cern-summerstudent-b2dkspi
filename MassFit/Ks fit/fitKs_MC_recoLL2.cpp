...
//void fitKs_MC_recoLL2()
{   
    //Binned or unbinned fit?
    bool binned=false;
    
	///Load file
	TFile* file= new TFile("/afs/cern.ch/work/m/mbuhayeu/public/cern-summerstudent-b2dkspi-master/Data/MC_B2DKspi_LL_12_BdDstKspi.root");
	...
	*/
	...
	//pdf list
	RooAbsPdf* sig1 = new RooAddPdf("sig1", "sig1", RooArgList(CB, CB1), RooArgList(n_sig1, n_sig2));
	...
	c->SaveAs("/afs/cern.ch/work/m/mbuhayeu/public/cern-summerstudent-b2dkspi-master/MassFit/fitKs_MC_recoLL2.png");
